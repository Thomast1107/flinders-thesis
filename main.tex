...
\begin{abstract}
 ...
 Oxygen saturation and pulse rate  are two main measurements in the clinical aspects which indicates the state of a person's body functions.Oxygenated and deoxygenated have different optical chracteristics which can be measured with teh help of a probe placed in the fingertip  The primary objective of this research project is to develop a low cost medical device platform with a parameter spo2 into the market. Implementation of a medical device into the market among other competitors is a very much expensive task. Providing such a medical device platform in a  very low cost among the other competitors pave ways to maany small startups to do their innovations. 

This project mainly focus on providing medical ailments to the backward and people in the disaster prone areas. The low cost and miniature form makes it easier to carry this device and use it in different conditions. The process certification plays a major role in determining the cost of the medical device. As this platform pave ways in implementing a new idea in the medical field.  
